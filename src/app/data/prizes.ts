...
export const prizes: Prize[] = [
  ...
  },
  {
    ...
    tierLabel: '7스탬프 리워드',
    checkinsRequired: 7,
    title: '코레일 해랑열차 1명 추첨',
    subtitle: '프리미엄 관광열차 해랑 탑승권',
    description: '7번째 스탬프 달성 시 자동으로 추첨에 등록됩니다. 코레일 프리미엄 관광열차 해랑 탑승권을 1명에게 드립니다.',
    image: 'https://images.unsplash.com/photo-1474487548417-781cb71495f3?w=600&q=80',
    deliveryMethod: '추첨 후 모바일 발송',
    deliveryType: 'lottery',
    dailyLimit: null,
    limitPeriod: '캠페인 기간 내 추첨 · 1명',
    themeColor: '#E8A000',
    bgColor: '#FFFBEB',
    borderColor: '#FCD34D',
    emoji: '🚂',
    ...
    isLottery: true,
    grandPrizes: [
      { name: '코레일 해랑열차 탑승권', quantity: '1명', emoji: '🚂' },
    ],
  },
];